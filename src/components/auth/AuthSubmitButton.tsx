...
export function AuthSubmitButton({
  ...
  return (
    ...
    >
      ...
      <span
        className="absolute inset-0 bg-navy-deep origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)]"
        aria-hidden
      />
