...
export function GoogleAuthButton({
  ...
  return (
    <button
      ...
      className="group w-full h-12 rounded-full border border-line bg-surface text-ink font-semibold text-sm tracking-tight inline-flex items-center justify-center gap-2.5 transition-all duration-300 hover:bg-[oklch(0.98_0.005_85)] hover:shadow-2 disabled:opacity-60 disabled:cursor-not-allowed active:scale-[0.98]"
    >
