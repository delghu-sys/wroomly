...
export function BrandChip({
  ...
  const styles = {
    primary:
      'bg-[oklch(0.84_0.17_85)] text-[oklch(0.22_0.075_256)] border border-[oklch(0.84_0.17_85)]',
    ghost:
    ...
    navy:
      'bg-[oklch(0.22_0.075_256)] text-[oklch(0.84_0.17_85)] border border-[oklch(0.22_0.075_256)]',
  } as const
