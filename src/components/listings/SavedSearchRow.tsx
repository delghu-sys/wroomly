  ...
  return (
    <div className="rounded-2xl border border-line bg-surface p-4 sm:p-5 flex flex-col sm:flex-row gap-4 sm:gap-5 sm:items-center">
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        <Link
          href={browseUrl}
          className="inline-flex items-center gap-1 h-9 px-3 rounded-full text-[12px] font-medium bg-navy-deep text-maize-bright hover:bg-navy-deep/90 transition active:scale-[0.97]"
        >
