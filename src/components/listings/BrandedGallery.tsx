      ...
      <div className="space-y-3">
        ...
        >
          ...
          <button
            ...
            className="absolute right-4 top-4 w-10 h-10 rounded-full bg-white/85 backdrop-blur hover:bg-surface text-ink flex items-center justify-center shadow-on-media transition-all duration-300 active:scale-[0.92] hover:scale-105 focus:outline-none focus-visible:ring-4 focus-visible:ring-maize-bright/50"
          >
          ...
          {images.length > 1 && (
            <>
              <button
                ...
                className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white/85 backdrop-blur hover:bg-surface text-ink flex items-center justify-center shadow-on-media transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] active:scale-[0.92] hover:scale-105"
              ...
              <button
                ...
                className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white/85 backdrop-blur hover:bg-surface text-ink flex items-center justify-center shadow-on-media transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] active:scale-[0.92] hover:scale-105"
              ...
              >
                ...
                <div
                  className={`absolute inset-0 transition-opacity duration-300 ${
                    i === current ? 'opacity-0' : 'opacity-50 bg-surface'
                  }`}
                  aria-hidden
                />
                {/* Active ring */}
