  ...
  return (
    <DropdownMenu onOpenChange={open => open && track('share_opened', { listingId })}>
      <DropdownMenuTrigger
        ...
        className="inline-flex items-center gap-1.5 h-10 px-4 rounded-full border border-line bg-surface text-[13px] font-medium text-ink hover:border-maize-bright/50 transition active:scale-[0.98]"
      >
