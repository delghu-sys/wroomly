  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="mt-12 rounded-3xl border border-line bg-surface p-7 text-center">
        ...
        <Link
          href="/listings"
          className="inline-flex items-center gap-1.5 mt-5 h-11 px-6 rounded-full bg-[oklch(0.10_0.02_260)] text-[oklch(0.84_0.17_85)] text-sm font-semibold hover:bg-[oklch(0.10_0.02_260)]/90 transition active:scale-[0.98]"
        >
