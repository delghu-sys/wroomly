...
const PUBLIC_ROUTES = ['/', '/listings', '/about', '/terms', '/privacy', '/safety', '/guides', '/buildings', '/coming-soon', '/start-listing', '/list-place']
...
const PUBLIC_FILES = ['/sitemap.xml', '/robots.txt', '/manifest.webmanifest', '/llms.txt', '/og-default.png']
